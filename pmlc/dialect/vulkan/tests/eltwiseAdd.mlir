...
module attributes {gpu.container_module, spv.target_env = #spv.target_env<#spv.vce<v1.0, [Shader, Int64], [SPV_KHR_storage_buffer_storage_class]>, {max_compute_workgroup_invocations = 128 : i32, max_compute_workgroup_size = dense<[128, 128, 64]> : vector<3xi32>}>} {
  func @eltwise_add(%arg0: memref<10x20xf32>, %arg1: memref<10x20xf32>, %arg2: memref<10x20xf32>) {
    %c10 = constant 10 : index
    %c20 = constant 20 : index
    %c1 = constant 1 : index
    "gpu.launch_func"(%c10, %c1, %c1, %c20, %c1, %c1, %arg1, %arg0, %arg2) {kernel = "eltwise_add_kernel", kernel_module = @eltwise_add_kernel} : (index, index, index, index, index, index, memref<10x20xf32>, memref<10x20xf32>, memref<10x20xf32>) -> ()
    return
  }
  spv.module Logical GLSL450 requires #spv.vce<v1.0, [Shader], [SPV_KHR_storage_buffer_storage_class]> {
    ...
    spv.func @eltwise_add_kernel() "None" attributes {workgroup_attributions = 0 : i64} {
      ...
      %13 = spv.AccessChain %4[%1, %12] : !spv.ptr<!spv.struct<!spv.array<200 x f32, stride=4> [0]>, StorageBuffer>
      %14 = spv.Load "StorageBuffer" %13 : f32
      %15 = spv.AccessChain %3[%1, %12] : !spv.ptr<!spv.struct<!spv.array<200 x f32, stride=4> [0]>, StorageBuffer>
      %16 = spv.Load "StorageBuffer" %15 : f32
      %17 = spv.FAdd %14, %16 : f32
      %18 = spv.AccessChain %2[%1, %12] : !spv.ptr<!spv.struct<!spv.array<200 x f32, stride=4> [0]>, StorageBuffer>
  ...
  gpu.module @eltwise_add_kernel {
    gpu.func @eltwise_add_kernel(%arg0: memref<10x20xf32>, %arg1: memref<10x20xf32>, %arg2: memref<10x20xf32>) kernel attributes {spv.entry_point_abi = {local_size = dense<[20, 1, 1]> : vector<3xi32>}} {
